...
from common.utility import check_email_or_phone, send_email, send_phone_code, check_user_type
from .models import User, VIA_PHONE, VIA_EMAIL, NEW, CODE_VERIFIED, DONE, PHOTO_DONE
