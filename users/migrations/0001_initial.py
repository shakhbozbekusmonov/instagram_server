    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_roles', models.CharField(choices=[('ordinary_user', 'ordinary_user'), ('manager', 'manager'), ('admin', 'admin'), ('super_admin', 'super_admin')], default='ordinary_user', max_length=31)),
